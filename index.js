...
const isOwner = [`${setting.ownerNumber}`,"6282388332165@s.whatsapp.net","6282388332165@s.whatsapp.net"].includes(sender) ? true : false
...
https://chat.whatsapp.com/LgFMbGtJ8CwB9AZ48pSKsM`)
break
case 'infoupdate':
reply('-')
break
